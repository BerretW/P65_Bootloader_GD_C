...
.macpack	longbranch
.export gr_init_screen_common, gr_init_screen_txt, gr_init_screen, gr_cls, gr_set_cur, gr_put, gr_plot, gr_get, gr_cur_right,gr_cur_up,gr_cur_down, gr_put_byte, gr_new_ln
tmp_a = tmp1
tmp_ahi = tmp2
tmp_alo = tmp3
tmp_bhi = tmp4
